...
;~ DirCreate('.\temp\lib\ImageSearch')

#Region When running compiled script, Install needed DLLs if they don't exist yet
;~ FileInstall(".\lib\ImageSearch\ImageSearchDLLx32.dll", ".\temp\lib\ImageSearch\ImageSearchDLLx32.dll") ;FileInstall ( "source", "dest" [, flag = 0] )
;~ FileInstall(".\lib\ImageSearch\ImageSearchDLLx64.dll", ".\temp\lib\ImageSearch\ImageSearchDLLx64.dll")
;~ FileInstall(".\lib\ImageSearch\msvcr110d.dll", ".\temp\lib\ImageSearch\msvcr110d.dll") ;Microsoft Visual C++ Redistributable dll x64
;~ FileInstall(".\lib\ImageSearch\msvcr110.dll", ".\temp\lib\ImageSearch\msvcr110.dll") ;Microsoft Visual C++ Redistributable dll x32
...
Func _ImageSearchStartup()
	...
	If $sOSArch = "X86" Or $sAutoItX64 = 0 Then
		$h_ImageSearchDLL = DllOpen(StringLeft(@ScriptDir, StringInStr(@ScriptDir, '\', 0, -2)) & "lib\ImageSearch\ImageSearchDLLx32.dll")
		If $h_ImageSearchDLL = -1 Then Return "DllOpen failure"
	ElseIf $sOSArch = "X64" And $sAutoItX64 = 1 Then
		$h_ImageSearchDLL = DllOpen(StringLeft(@ScriptDir, StringInStr(@ScriptDir, '\', 0, -2)) & "lib\ImageSearch\ImageSearchDLLx64.dll")
		If $h_ImageSearchDLL = -1 Then Return "DllOpen failure"
	Else
